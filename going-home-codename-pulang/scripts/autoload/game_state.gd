...
const DEFAULT_SETTINGS := {"reduced_motion": true, "riding_assist": true, "fov": 70.0, "master": 0.75, "vehicle": 0.55, "ambience": 0.65, "quality": 1, "fps_limit": 60, "text_size": 22, "touch": false}
...
var phone: Dictionary = {"read": [], "replies": {}}
